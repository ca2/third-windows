...
{ "ER_OUT_OF_SORTMEMORY", 1038, "Out of sort memory, consider increasing server sort buffer size_i32" },
...
{ "ER_TOO_BIG_ROWSIZE", 1118, "Row size_i32 too large. The maximum row size_i32 for the used table type, not counting BLOBs, is %ld. This includes storage overhead, check the manual. You have to change some columns to TEXT or BLOBs" },
...
{ "ER_LOCK_TABLE_FULL", 1206, "The total number of locks exceeds the lock table size_i32" },
...
{ "ER_TOO_BIG_FOR_UNCOMPRESS", 1256, "Uncompressed data size_i32 too large; the maximum size_i32 is %d (probably, length of uncompressed data was corrupted)" },
...
{ "ER_WARN_QC_RESIZE", 1282, "Query cache failed to set size_i32 %lu; new query cache size_i32 is %lu" },
...
{ "ER_LOAD_FROM_FIXED_SIZE_ROWS_TO_VAR", 1409, "Can\'t load value from file with fixed size_i32 rows to variable" },
...
{ "ER_WRONG_SIZE_NUMBER", 1531, "A size_i32 parameter was incorrectly specified, either number or on the form 10M" },
{ "ER_SIZE_OVERFLOW_ERROR", 1532, "The size_i32 number was correct but we don\'t allow the digit part to be more than 2 billion" },
...
{ "ER_DEBUG_SYNC_TIMEOUT", 1639, "debug sync point_i32 wait timed out" },
{ "ER_DEBUG_SYNC_HIT_LIMIT", 1640, "debug sync point_i32 hit limit reached" },
...
{ "ER_INDEX_COLUMN_TOO_LONG", 1709, "Index column size_i32 too large. The maximum column size_i32 is %lu bytes." },
...
{ "ER_MTS_EVENT_BIGGER_PENDING_JOBS_SIZE_MAX", 1864, "Cannot schedule event %s, relay-log name %s, position %s to Worker thread because its size_i32 %lu exceeds %lu of slave_pending_jobs_size_max." },
...
{ "ER_INVALID_FIELD_SIZE", 3013, "Invalid size_i32 for column \'%-.192s\'." },
