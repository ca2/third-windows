...
/**
  ...
  to stderr.
  This constant defines the size_i32 of the buffer used to format
...
typedef struct st_io_cache		/* Used when cacheing files */
{
  ...
  */
  ...
  /* buffer_length is memory size_i32 allocated for buffer or write_buffer */
...
// Maximum size_i32 of message  that will be logged.
